About pdfminer3k-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdfminer3k-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/jaepil/pdfminer3k

Documentation: https://github.com/jaepil/pdfminer3k
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5955&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdfminer3k-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdfminer3k` can be installed with `conda`:
...
```
mamba install pdfminer3k
```

It is possible to list all of the versions of `pdfminer3k` available on your platform with `conda`:
...
```
mamba search pdfminer3k --channel conda-forge
```
...
mamba repoquery search pdfminer3k --channel conda-forge

# List packages depending on `pdfminer3k`:
mamba repoquery whoneeds pdfminer3k --channel conda-forge

# List dependencies of `pdfminer3k`:
mamba repoquery depends pdfminer3k --channel conda-forge
```
